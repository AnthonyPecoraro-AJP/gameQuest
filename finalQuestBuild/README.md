...
This project modifies code from Chris Bradfield's "Shmup" project. It uses self-made pixel art, and modifies the overall format of Chris Bradfields code structure. The game runs like a basic "shoot-em-up" and has health powerups and lazer powerups. Mobs spawn in consistently when all are destroyed.

Getting Started These instructions will get you a copy of the project up and running on your local machine for development and testing purposes. See deployment for notes on how to deploy the project on a live system.

Must have python and pygame installed

You can download python by doing a quick search on google. You can also do this with pygame.
